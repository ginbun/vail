...
field="versionGt81"
                   ...
                   hide-asterisk>
        <a-switch
v-model="formModel.versionGt81"
                  type="round"
                  checked-text=">= 8.1"
                  unchecked-text="< 8.1" />
      </a-form-item>
      <a-collapse class="advanced-settings" :bordered="false">
        <a-collapse-item key="1" header="高级设置">
          <!-- 域 -->
          <a-form-item
field="domain"
                       label="域"
...
field="keyboardLayout"
                       ...
                       hide-asterisk>
            <a-select
v-model="formModel.keyboardLayout"
                      placeholder="请选择系统键盘布局"
                      :options="toOptions(keyboardLayoutKey)" />
          </a-form-item>
          <!-- 剪切板规范 -->
          <a-form-item
field="clipboardNormalize"
                       label="剪切板规范"
                       hide-asterisk>
            <a-select
v-model="formModel.clipboardNormalize"
                      placeholder="请选择剪切板规范"
                      :options="toOptions(clipboardNormalizeKey)" />
          </a-form-item>
          <!-- 预连接id -->
          <a-form-item
field="preConnectionId"
                       label="预连接id"
                       hide-asterisk>
            <a-input
v-model="formModel.preConnectionId"
                     placeholder="请输入预连接id"
                     allow-clear />
          </a-form-item>
          <!-- 预连接数据 -->
          <a-form-item
field="preConnectionBlob"
                       label="预连接数据"
                       hide-asterisk>
            <a-input
v-model="formModel.preConnectionBlob"
...
field="remoteAppDir"
                       ...
                       hide-asterisk>
            <a-input
v-model="formModel.remoteAppDir"
...
field="remoteAppArgs"
                       ...
                       hide-asterisk>
            <a-input
v-model="formModel.remoteAppArgs"
