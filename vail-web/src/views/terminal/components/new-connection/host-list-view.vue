...
<script lang="ts" setup>
  ...
  import { openExtraModalKey, TerminalSessionTypes, ExtraSettingItems } from '../../types/const';
  ...
  // 打开配置
  const openSetting = inject(openExtraModalKey) as (record: HostQueryResponse) => void;
