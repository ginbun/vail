...
v-model="formModel.channelType"
        ...
        <!-- 消息分类 -->
        <a-form-item
v-if="formModel.channelType === ChannelType.WEBSITE"
                     field="messageClassify"
                     label="消息分类">
          <a-select
v-model="formModel.messageClassify"
...
v-model="formModel.messageType"
        ...
        <!-- webhook -->
        <a-form-item
v-if="formModel.channelType && getDictValue(ChannelTypeKey, formModel.channelType, 'notifyType') === NotifyType.WEBHOOK"
                     field="webhook"
                     label="webhook">
          <a-textarea
v-model="formModel.webhook"
        ...
        <!-- 签名密钥 -->
        <a-form-item
v-if="formModel.channelType === ChannelType.DING || formModel.channelType === ChannelType.FEI_SHU"
                     field="secret"
                     label="签名密钥">
          <a-input
...
field="messageTemplate"
          ...
          <a-textarea
v-model="formModel.messageTemplate"
